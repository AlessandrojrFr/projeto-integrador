  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" >
          <img class="img" src="imagens_barcelona/juni1.avif" class="card-img-top" alt="...">
        </div>
      </div>
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" >
          <img class="img" src="imagens_barcelona/juni2.avif" class="card-img-top" alt="...">
        </div>
      </div>
      <div class="col-sm-6 col-md-4 col-lg-3">
    ...
    <div class="row">
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" >
          <img class="img" src="imagens_barcelona/juni3.avif" class="card-img-top" alt="...">
        </div>
      </div>
      <div class="col-sm-6 col-md-4 col-lg-3">
        <div class="card" >
          <img class="img" src="imagens_barcelona/juni4.avif" class="card-img-top" alt="...">
        </div>
      </div>
    </div>
  </div>
