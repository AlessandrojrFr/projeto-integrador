  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid">
        <a class="navbar-brand" href="masculino.php"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="18" viewBox="0 0 20 18" fill="none">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item">
              ...
              <a class="nav-link active" aria-current="page" href="masculino.php">𝙎𝙉𝙆𝙍𝙎</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="masculino.php"></a>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="masculino.php">𝘑𝘶𝘯𝘵𝘦-𝘴𝘦 𝘢 𝘯𝘰́𝘴</a></li>
                <li><a class="dropdown-item" href="masculino.php">𝑬𝒔𝒄𝒓𝒆𝒗𝒆𝒓 𝒂𝒒𝒖𝒊</a></li>
                <li>
                  <hr class="dropdown-divider">
                </li>
                <li><a class="dropdown-item" href="masculino.css">𝑬𝒔𝒄𝒓𝒆𝒗𝒆𝒓 𝒂𝒒𝒖𝒊</a></li>
              </ul>
            </li>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="masculino.php">Cadastra - se</a></li>
                <li><a class="dropdown-item" href="masculino.php">𝑬𝒔𝒄𝒓𝒆𝒗𝒆𝒓 𝒂𝒒𝒖𝒊</a></li>
                <li>
                  <hr class="dropdown-divider">
                </li>
