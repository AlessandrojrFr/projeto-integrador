...
=======
  ...
  <link rel="stylesheet" href="css2/fonts-icones.css">
>>>>>>> cbc6d5498c3205efbb46d14d1d446c8fe963ebf1
  ...
  <div id="carouselExampleIndicators" class="carousel slide">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="CARROSEL\carrosel_azul.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="CARROSEL\carrosel_azul4.jpg" class="d-block w-100" alt="...">
      </div>
      <div class="carousel-item">
        <img src="CARROSEL\carrosel_azul3.jpg" class="d-block w-100" alt="...">
      </div>
    </div>
      ...
      <div class="col">
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            <h5 class="card-title">Card title</h5>
            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
            <a href="#" class="btn btn-primary">Comprar<br><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-bag-check-fill" viewBox="0 0 16 16">
